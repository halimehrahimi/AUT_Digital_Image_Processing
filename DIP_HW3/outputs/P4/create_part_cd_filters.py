...
train = []
gender = ['M', 'W']
ind = ['01','02','03','04','05','06','07','08','09','10','11','12','13']
for gen in gender:
    for i in range(1,10):
        trainlist=[]
        for j in range(0,13):
...
for t in range(len(train)):
    ...
    filter_df.to_csv(path+'outputs/P4/c_mace_filters_csv/hfilter'+str(t)+'.csv',header=False,index=False)
    plt.imsave(path+'outputs/P4/c_mace filters/hfilter'+str(t)+'.jpg',np.abs(H), cmap='gray')
