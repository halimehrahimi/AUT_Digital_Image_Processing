...
golf_2 = cv2.imread(path+'inputs/P7/donald_plays_golf_2.png')
golf_2 = cv2.cvtColor(golf_2, cv2.COLOR_BGR2RGB)

resize(golf_2, np.array([0.1,0.25,0.5]), 'horizontal', 'donald_plays_golf_2')


# In[4]:


tennis_2 = cv2.imread(path+'inputs/P7/donald_plays_tennis_2.png')
tennis_2 = cv2.cvtColor(tennis_2, cv2.COLOR_BGR2RGB)

resize(tennis_2, np.array([0.1,0.25,0.5]), 'horizontal', 'donald_plays_tennis_2')
